...
def run_module():
    ...
    module_args = dict(
        ...
        dest=dict(type='str', required=False, default="/tmp/nasadefault.png")
    )
    ...
    # https://api.nasa.gov/planetary/earth/assets/?lon=77.593675&lat=12.972172&date=2016-03-09&api_key=DEMO_KEY

    nasaurl = f"https://api.nasa.gov/planetary/earth/assets/?lon={ module.params['lon'] }&lat={ module.params['lat'] }&date=2017-01-01&api_key={ module.params['apikey'] }"
    ...
    # assign JSON return value
    result['urlearth'] = nasaresp.get('url')
